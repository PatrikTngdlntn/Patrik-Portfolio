document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        EN: {
            ...
            hero_roles: "Fresh Graduate — Web Development & Technical Support",
            ...
            hero_overlay_role: "Tech Enthusias",
            hero_status_online: "Online",
            hero_contact_me: "Contact Me",
            about_title: "About Me",
            about_p1: "I am a <strong> Fresh Graduate of Informatics Engineering </strong> with an interest in IT Support, Networking, and Web Development. I have a foundational understanding of computer troubleshooting, operating system installation and configuration, hardware components, and basic network configuration.Through academic projects and independent learning, I have developed experience in problem-solving, system analysis, and web application development, while applying technical knowledge to practical projects. I am familiar with Windows, Microsoft Office, basic networking concepts, and web technologies such as PHP, Laravel, JavaScript, PostgreSQL, and MySQL. I am a fast learner who is eager to develop my technical skills through professional experience. I am particularly interested in IT operations, technical troubleshooting, computer and network infrastructure, and web application development, while continuously improving my knowledge and adapting to new technologies.",
            ...
            contact_title: "Open to Opportunities",
            contact_desc: "I'm a Fresh Graduate in Informatics Engineering, actively seeking internship or entry-level positions in Web Development and IT Support. Reach out — I'd love to connect!",
        ...
        ID: {
            ...
            hero_roles: "Lulusan Baru — Pengembangan Web & Dukungan Teknis",
            ...
            hero_overlay_role: "Penggemar Teknologi",
            hero_status_online: "Online",
            hero_contact_me: "Hubungi Saya",
            about_title: "Tentang Saya",
            about_p1: "Saya adalah seorang <strong>Fresh Graduate Teknik Informatika</strong> yang memiliki minat di bidang dukungan TI (IT Support), jaringan, dan pengembangan web. Saya memiliki pemahaman dasar mengenai pemecahan masalah komputer (*troubleshooting*), instalasi dan konfigurasi sistem operasi, komponen perangkat keras, serta konfigurasi jaringan dasar.Melalui proyek akademik dan pembelajaran mandiri, saya telah mengembangkan pengalaman dalam pemecahan masalah, analisis sistem, dan pengembangan aplikasi web, sembari menerapkan pengetahuan teknis pada proyek-proyek praktis. Saya menguasai penggunaan Windows, Microsoft Office, konsep dasar jaringan, serta teknologi web seperti PHP, Laravel, JavaScript, PostgreSQL, dan MySQL. Saya adalah pribadi yang cepat belajar dan bersemangat untuk mengembangkan keterampilan teknis melalui pengalaman profesional. Saya memiliki minat khusus pada operasi TI, pemecahan masalah teknis, infrastruktur komputer dan jaringan, serta pengembangan aplikasi web, sembari terus meningkatkan pengetahuan dan beradaptasi dengan teknologi baru.",
            ...
            contact_title: "Terbuka terhadap Peluang",
            contact_desc: "Saya lulusan baru Teknik Informatika, aktif mencari magang atau posisi tingkat awal di bidang Pengembangan Web dan Dukungan TI. Hubungi saya — saya ingin sekali terhubung.",
